...
<html lang="de">
  <head>
    ...
    <meta name="author" content="Testumgebung">
    <link rel="icon" href="favicon.ico">

    <title>Mückenhaupt</title>
		    ...
		    <div class="col-md-12">
			    <div class="zentriert">
					...
					<div class="noDesktopDisplay">
						...
						<ul class="dlList">
							<li>
								<a href="downloads/TUEV-Zertifikat_M%C3%BCckenhaupt.pdf" target="_blank">
									TÜV-Zertifikat (deutsch)
								</a>
							</li>
							<li>
								<a href="downloads/Anhang_TUEV-Zertifikat_M%C3%BCckenhaupt.pdf" target="_blank">
									TÜV-Zertifikat (deutsch), Anhang
								</a>
							</li>
							<li>
								<a href="downloads/TUEV-Zertifikat_english.pdf" target="_blank">
									TÜV-Zertifikat (englisch)
								</a>
							</li>
							<li>
								<a href="downloads/Anhang_TUEV-Zertifikat_english.pdf" target="_blank">
									TÜV-Zertifikat (englisch), Anhang
								</a>
							</li>
							<li>
								<a href="downloads/Genehmigungsbescheid.pdf" target="_blank">
									Genehmigungsbescheid
								</a>
							</li>

							<li>
								<a href="downloads/blau.pdf" target="_blank">
									Blauschein
								</a>
							</li>
						</ul>
					...
					<div class="col-md-2 ">
						<div class="demo-2 effect">
							<h2 class="zero">TÜV-Zertifikat (deutsch)</h2>
							<a href="downloads/TUEV-Zertifikat_M%C3%BCckenhaupt.pdf" target="_blank">
								<img class="top" src="downloads/tuevurkunde.jpg" alt=""/>
							</a>
						</div>
					</div>
					<div class="col-md-2 ">
						<div class="demo-2 effect">
							<h2 class="zero">TÜV-Zertifikat (deutsch), Anhang</h2>
							<a href="downloads/Anhang_TUEV-Zertifikat_M%C3%BCckenhaupt.pdf" target="_blank">
								<img class="top" src="downloads/Tuevzertifikat_anhang.jpg" alt=""/>
							</a>
						</div>
					</div>
					<div class="col-md-2 ">
						<div class="demo-2 effect">
							<h2 class="zero">TÜV-Zertifikat (englisch), Anhang</h2>
							<a href="downloads/TUEV-Zertifikat_english.pdf" target="_blank">
								<img class="top" src="downloads/tuevurkunde_english.jpg" alt=""/>
							</a>
						</div>
					</div>
					<div class="col-md-2 ">
						<div class="demo-2 effect">
							<h2 class="zero">TÜV-Zertifikat (englisch), Anhang</h2>
							<a href="downloads/Anhang_TUEV-Zertifikat_english.pdf" target="_blank">
								<img class="top" src="downloads/Tuevzertifikat_anhang_gb.jpg" alt=""/>
							</a>
						</div>
					</div>
					<div class="col-md-2 ">
						<div class="demo-2 effect">
							...
							<a href="downloads/Genehmigungsbescheid.pdf" target="_blank">
								<img class="top" src="downloads/genehmigungsbescheid.jpg" alt=""/>
							</a>
						</div>
					</div>
					<div class="col-md-2 ">
						<div class="demo-2 effect">
							<h2 class="zero">Blauschein</h2>
							<a href="downloads/blau.pdf" target="_blank">
								<img class="top" src="downloads/blauschein.jpg" alt=""/>
							</a>
						</div>
					</div>
